...
def main():
    ...
    parser.add_argument("--base-model", type=str, default="deepseek-ai/DeepSeek-R1-Distill-Qwen-7B",
                        help="Base model name for loading LoRA")
    ...
    parser.add_argument("--batch-size", type=int, default=8, help="Batch size for LoRA inference")
    parser.add_argument("--max-length", type=int, default=512)
    parser.add_argument("--no-lora", action="store_true", help="Skip LoRA predictions (use only PPL)")
    parser.add_argument("--no-ppl", action="store_true", help="Skip PPL predictions (use only LoRA)")
    ...
    for subset in subsets:
        ...
        if not args.no_lora:
            ...
            if lora_model is None:
                print("  LoRA model not found, skipping LoRA predictions")
        ...
        if lora_model is None and ppl_clf is None:
